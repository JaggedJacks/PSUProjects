...
public class CodingChallenge5JDD {
...
//		System.out.println("File \"" + numFile + "\" created");
	...
	/*
	 * Method to prompt for the filename to read
	 */
	public static void getMyFile() {
		System.out.println("");
		String fileName, stringToSearch;
		scanner = new Scanner(System.in); // Scanner for user input
		...
		try {
			...
			stringToSearch = scanner.next();
			System.out.println("");
			System.out.println("");
			System.out.println("");
			System.out.println("The following lines were found:");
			readLines(fileReader, stringToSearch); // calls method to read file
	 ...
	 */
	public static void readLines(FileReader filePath, String stringToSearch) {
		String line = "";
		try {
			// BufferedReader
			...
			while ((line = bufferedReader.readLine()) != null) {
				if (line.toLowerCase().contains(stringToSearch.toLowerCase())) {
					System.out.println("");
					System.out.println(line); // print out line that contains the text that was typed
				}
			}
			// close the file
